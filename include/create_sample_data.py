...
product_types = {
    'Electronics': ['Smartphone', 'Laptop', 'Tablet', 'Headphones', 'Camera', 'TV', 'Speaker', 'Watch'],
    ...
    'Home & Garden': ['Chair', 'Table', 'Lamp', 'Vase', 'Plant', 'Tool', 'Cushion', 'Rug'],
    'Sports': ['Ball', 'Racket', 'Shoes', 'Shirt', 'Equipment', 'Bag', 'Bottle', 'Gloves'],
    'Beauty': ['Lipstick', 'Foundation', 'Perfume', 'Shampoo', 'Cream', 'Mascara', 'Lotion', 'Soap'],
    'Automotive': ['Tire', 'Battery', 'Oil', 'Filter', 'Light', 'Mirror', 'Seat Cover', 'Mat'],
...
for i in range(1, n_products + 1):
    ...
    created_date = datetime(2023, 1, 1) + timedelta(days=created_days, hours=created_hours)
