...
class GenETLAIAnalyzer:
                ...
                insights.append(
                    DataInsight(
                        ...
                        data_points={
                            ...
                            "top_expensive": expensive_products.nlargest(3, "price")[
            ...
            insights.append(
                DataInsight(
                    ...
                    data_points={
                        ...
                        "highest_price": round(
                            category_prices.loc[most_expensive_category, "mean"], 2
                        ),
                        "lowest_category": cheapest_category,
                        "lowest_price": round(
                            category_prices.loc[cheapest_category, "mean"], 2
                        ),
                        "price_spread": round(
                            category_prices.loc[most_expensive_category, "mean"]
                            - category_prices.loc[cheapest_category, "mean"],
                            2,
                        ),
                    },
    ...
    def analyze_inventory_intelligence(self, df: pd.DataFrame) -> List[DataInsight]:
        ...
        try:
            ...
            out_of_stock_pct = (
                stock_distribution.get("Out of Stock", 0) / total_products
            ) * 100
            low_stock_pct = (
                stock_distribution.get("Low Stock", 0) / total_products
            ) * 100
            ...
            if out_of_stock_pct > 5:  # If more than 5% out of stock
                insights.append(
                    DataInsight(
                        ...
                        confidence=0.98,
                        data_points={
                            "out_of_stock_count": stock_distribution.get(
                                "Out of Stock", 0
                            ),
            ...
            category_stock = (
                df.groupby(["category", "stock_status"]).size().unstack(fill_value=0)
            )
    ...
    def analyze_quality_intelligence(self, df: pd.DataFrame) -> List[DataInsight]:
        ...
        try:
                ...
                insights.append(
                    DataInsight(
                        ...
                        data_points={
                            ...
                            "worst_products": low_rated_products.nsmallest(3, "rating")[
            ...
            category_ratings = (
                df.groupby("category")["rating"].agg(["mean", "count"]).round(2)
            )
            ...
            insights.append(
                DataInsight(
                    ...
                    data_points={
                        ...
                        "best_rating": float(
                            category_ratings.loc[best_category, "mean"]
                        ),
                        "worst_category": worst_category,
                        "worst_rating": float(
                            category_ratings.loc[worst_category, "mean"]
                        ),
                        "rating_gap": round(
                            category_ratings.loc[best_category, "mean"]
                            - category_ratings.loc[worst_category, "mean"],
    ...
    def generate_predictive_insights(self, df: pd.DataFrame) -> List[DataInsight]:
        ...
        try:
            ...
            recent_products = df[
                df["created_date"] > (datetime.now() - timedelta(days=30))
            ]
            ...
            if len(recent_products) > 0:
                ...
                trend_direction = (
                    "improving"
                    if recent_avg_rating > overall_avg_rating
                    else "declining"
                )
            ...
            high_rated_expensive = df[
                (df["rating"] > 4.0) & (df["price"] > df["price"].median())
            ]
                ...
                insights.append(
                    DataInsight(
                        ...
                        data_points={
                            ...
                            "avg_premium_rating": round(
                                high_rated_expensive["rating"].mean(), 2
                            ),
                            "avg_premium_price": round(
                                high_rated_expensive["price"].mean(), 2
                            ),
                        },
        ...
        results = {
            ...
            "metadata": {
                "high_priority_count": len(
                    [i for i in all_insights if i.priority == "HIGH"]
                ),
                "medium_priority_count": len(
                    [i for i in all_insights if i.priority == "MEDIUM"]
                ),
                "low_priority_count": len(
                    [i for i in all_insights if i.priority == "LOW"]
                ),
                "average_confidence": round(
                    np.mean([i.confidence for i in all_insights]), 2
                ),
            },
        }
...
def main():
    ...
    print(
        f"Generated {results['total_insights_generated']} insights with {results['metadata']['average_confidence']:.0%} average confidence"
    )
